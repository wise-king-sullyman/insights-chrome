  ...
  const addIPModal = (
    ...
    >
      <Form onSubmit={(event: React.FormEvent<HTMLFormElement>) => event.preventDefault()}>
        <FormGroup>
          <Content>
            <Content component="p">Before connecting to your satellite servers, Red Hat needs to add your IP address or range of IP addresses to an allow-list.</Content>
          </Content>
          <TextInput
  ...
  const removeIPModal = (
    ...
    >
      <Form onSubmit={(event: React.FormEvent<HTMLFormElement>) => event.preventDefault()}>
        <FormGroup>
          <Content>
            <Content component="p">The following IP addresses will be removed from the allow list</Content>
          </Content>
